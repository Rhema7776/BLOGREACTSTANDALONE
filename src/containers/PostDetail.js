...
import {Button, Container, Divider, Item,  Header, Image, Icon, Modal } from 'semantic-ui-react';
    ...
    <Container>
        ...
        { data && [
          <div>   
            ...
            <PostUpdate postSlug={postSlug} initialTitle={data.title} initialContent={data.content} initialThumbnail={data.thumbnail} /> 
          </div>
        ]}
